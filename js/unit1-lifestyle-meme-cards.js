...
(function (global) {
  ...
  var P1_LUCAS = [
    {
      id: "idea-of-fun",
      img: "img/life-p1-01-idea-of-fun.webp",
    ...
    },
    {
      ...
      img: "img/life-p1-02-realise-important.webp",
    ...
    {
      id: "scripts-all-over",
      img: "img/life-p1-03-scripts-all-over.webp",
    ...
    {
      id: "bit-of-a-mess",
      img: "img/life-p1-04-bit-of-a-mess.webp",
    ...
    {
      id: "lose-track",
      img: "img/life-p1-05-lose-track.webp",
    ...
    {
      id: "passionate-about",
      img: "img/life-p1-06-passionate-about.webp",
    ...
    {
      id: "turned-up-late",
      img: "img/life-p1-07-turned-up-late.webp",
    ...
    {
      id: "unwinding",
      img: "img/life-p1-08-unwinding.webp",
    ...
    {
      id: "bedtime",
      img: "img/life-p1-09-bedtime.webp",
      hints: ["bedtime is"],
      sentence:
        "After a performance I eat and spend a few hours unwinding, so bedtime is often one or two in the morning.",
    ...
    {
      id: "out-like-a-light",
      img: "img/life-p1-10-out-like-a-light.webp",
  ...
  var P2_MAJA = [
    {
      id: "love-the-fact",
      img: "img/life-p2-01-love-the-fact.webp",
    ...
    {
      id: "short-walk",
      img: "img/life-p2-02-short-walk.webp",
    ...
    {
      id: "reasonably-late",
      img: "img/life-p2-03-reasonably-late.webp",
    ...
    {
      id: "decent-breakfast",
      img: "img/life-p2-04-decent-breakfast.webp",
    ...
    {
      id: "fully-qualified",
      img: "img/life-p2-05-fully-qualified.webp",
    ...
    {
      id: "tend-to",
      img: "img/life-p2-06-tend-to.webp",
      hints: ["tend to"],
      sentence:
        "Now I'm fully qualified, I tend to get the advanced classes, which I find more interesting.",
      highlight: "tend to"
    ...
    {
      id: "catch-up-sleep",
      img: "img/life-p2-07-catch-up-sleep.webp",
    ...
    {
      id: "carry-on",
      img: "img/life-p2-08-carry-on.webp",
    ...
    {
      id: "settle-down",
      img: "img/life-p2-09-settle-down.webp",
      hints: ["settle down"],
      sentence:
    ...
    {
      id: "steady-secure",
      img: "img/life-p2-10-steady-secure.webp",
    ...
    {
      id: "made-up-mind",
      img: "img/life-p2-11-made-up-mind.webp",
  ...
  var P3_REO = [
    {
      id: "out-all-day",
      img: "img/life-p3-01-out-all-day.webp",
      hints: ["out all day"],
      sentence:
    ...
    {
      id: "exercise",
      img: "img/life-p3-02-exercise.webp",
    ...
    {
      id: "variety",
      img: "img/life-p3-03-variety.webp",
    ...
    {
      id: "not-all-cuddly",
      img: "img/life-p3-04-not-all-cuddly.webp",
    ...
    {
      id: "put-off",
      img: "img/life-p3-05-put-off.webp",
    ...
    {
      id: "loads-free-time",
      img: "img/life-p3-06-loads-free-time.webp",
    ...
    {
      id: "fit-marriage",
      img: "img/life-p3-07-fit-marriage.webp",
  ...
  var P4_BEN = [
    {
      id: "hanging-on-rope",
      img: "img/life-p4-01-hanging-on-rope.webp",
    ...
    {
      id: "make-a-living",
      img: "img/life-p4-02-make-a-living.webp",
    ...
    {
      id: "funding",
      img: "img/life-p4-03-funding.webp",
    ...
    {
      id: "unconventional",
      img: "img/life-p4-04-unconventional.webp",
    ...
    {
      id: "works-for-me",
      img: "img/life-p4-05-works-for-me.webp",
    ...
    {
      id: "feel-alive",
      img: "img/life-p4-06-feel-alive.webp",
