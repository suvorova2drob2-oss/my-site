      ...
      beats: [
        {
          ...
          drill: {
            ...
            bigIdea:
              "Own a messy creative routine — things that aren’t fun but matter, passions that steal time, then unwind and crash.",
            inventPrompt:
              "Invent one concrete detail about YOUR {{slot}} (a time, a mess, a late fail, how you unwind).",
            promptA: "What's your real daily routine?",
            promptAudio: {
              f: "audio/drill/real-daily-routine-f.mp3?v=2",
              m: "audio/drill/real-daily-routine-m.mp3?v=2",
            },
            modelB:
              "Normally I get out of bed around… with {{slot}} — though it's not really my idea of fun, but I realise it's important. My afternoons generally involve… scripts lying all over the place. It's a bit of a mess I'm ashamed to say. I'm passionate about… and I sometimes lose track of time — I once turned up late for…. Then I spend a few hours unwinding; my bedtime is… and I'm normally out like a light as soon as my head hits the pillow. Invent your {{slot}} detail.",
            partners: [
              { name: "Alex", slot: "late mornings", voice: "m" },
              { name: "Mira", slot: "a messy desk", voice: "f" },
              { name: "Jordan", slot: "museum rabbit holes", voice: "m" },
              { name: "Sam", slot: "post-work unwind", voice: "f" },
              { name: "Lea", slot: "a 1 a.m. bedtime", voice: "f" },
            ],
          },
        },
        {
          ...
          drill: {
            ...
            how: "Main idea + crown stems + invent a detail for the slot.",
            bigIdea:
              "Love the free setup — short walk, late start, catch-up sleep — but maybe it’s time to settle down for something steady.",
            inventPrompt:
              "Invent one concrete detail about YOUR {{slot}} (location perk, morning ritual, or the settle-down pressure).",
            promptA: "Could you live like that forever?",
            promptAudio: {
              f: "audio/drill/live-like-that-forever-f.mp3?v=2",
              m: "audio/drill/live-like-that-forever-m.mp3?v=2",
            },
            modelB:
              "Wherever I am, I love the fact that with {{slot}} I usually live just a short walk from… so I can get up reasonably late and still have time for a decent breakfast, then set off for work. I'm fully qualified now, so I tend to… and I can catch up on my sleep. But I'm not sure I can carry on doing this much longer — it might be time to settle down and get a more normal job, something steady and secure. I haven't made up my mind yet, though. Invent your {{slot}} twist.",
            partners: [
              { name: "Alex", slot: "living near work", voice: "m" },
              { name: "Mira", slot: "late breakfasts", voice: "f" },
              { name: "Jordan", slot: "catching up on sleep", voice: "m" },
              { name: "Sam", slot: "steady-job pressure", voice: "f" },
              { name: "Lea", slot: "settle-down talks at home", voice: "f" },
            ],
          },
        },
        {
          ...
          drill: {
            ...
            how: "Main idea + crown stems + invent a detail for the slot.",
            bigIdea:
              "Love the variety — but it’s not all cuddly, it can put people off, and there’s barely room for anything else.",
            inventPrompt:
              "Invent one concrete detail about YOUR {{slot}} (the cute myth vs the real downside / what won’t fit in).",
            promptA: "Is your job as cute as it looks?",
            promptAudio: {
              f: "audio/drill/job-as-cute-as-it-looks-f.mp3?v=2",
              m: "audio/drill/job-as-cute-as-it-looks-m.mp3?v=2",
            },
            modelB:
              "With {{slot}}, I tend to be out all day, so now I don't get as much exercise as I'd like to. I love my job, especially the variety — but it's not all cuddly. There are things which might put some people off working with… for life. It's not as if I have loads of free time to go looking, and there's not even room for a dog in my life, so I don't see how I'll be able to fit … in. Invent your {{slot}} detail.",
            partners: [
              { name: "Alex", slot: "being out all day", voice: "m" },
              { name: "Mira", slot: "less exercise than I'd like", voice: "f" },
              { name: "Jordan", slot: "the non-cuddly bit", voice: "m" },
              { name: "Sam", slot: "no free time to look", voice: "f" },
              { name: "Lea", slot: "no room for a dog", voice: "f" },
            ],
          },
        },
        {
          ...
          drill: {
            ...
            how: "Main idea + crown stems + invent a detail for the slot.",
            bigIdea:
              "An unconventional life needs funding — risk is real, you wouldn’t push it on everyone, but the danger (or rush) makes you feel alive.",
            inventPrompt:
              "Invent one concrete detail about YOUR {{slot}} (how you earn, what it pays for, why the risk is worth it).",
            promptA: "What funds your dream life?",
            promptAudio: {
              f: "audio/drill/funds-your-dream-life-f.mp3?v=2",
              m: "audio/drill/funds-your-dream-life-m.mp3?v=2",
            },
            modelB:
              "With {{slot}}, you might come across me… That's how I make a living and pay for…. Sponsors / a day job can provide funding and maybe food and equipment. It's a fairly unconventional way of life, and not one I'd actively encourage others to adopt — there's a lot of danger involved — but it works for me. It's precisely that sense of danger that makes me feel alive. Invent your {{slot}} detail.",
            partners: [
              { name: "Alex", slot: "a side hustle for trips", voice: "m" },
              { name: "Mira", slot: "sponsorship deals", voice: "f" },
              { name: "Jordan", slot: "unconventional hours", voice: "m" },
              { name: "Sam", slot: "danger at work", voice: "f" },
              { name: "Lea", slot: "what makes me feel alive", voice: "f" },
            ],
          },
        },
      ],
