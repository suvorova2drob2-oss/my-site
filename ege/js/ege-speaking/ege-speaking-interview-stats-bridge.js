/**
 * Speaking · interview-reply (Task 3) → Statistics Hub + activity log.
 */
(function (w) {
  var KEY = "ege_speaking_interview_scores";
  var GYM_KEY = "interview-reply";
  var SKILL = "Speaking: interview-reply";
  ...
  function recordAttempt(unitId, percent) {
    ...
    if (w.__egeActivityTracker && typeof w.__egeActivityTracker.recordActivity === "function") {
      w.__egeActivityTracker.recordActivity({
        label: SKILL,
        href: "ege-speaking-interview-reply.html",
        score: p
      });
    }
    return prev;
