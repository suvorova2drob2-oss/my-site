/**
 * Speaking · logic-comparison (Task 4) → Statistics Hub + activity log.
 */
(function (w) {
  var KEY = "ege_speaking_task4_scores";
  var GYM_KEY = "logic-comparison";
  var SKILL = "Speaking: logic-comparison";
  ...
  function recordAttempt(unitId, percent) {
    ...
    if (w.__egeActivityTracker && typeof w.__egeActivityTracker.recordActivity === "function") {
      w.__egeActivityTracker.recordActivity({
        label: SKILL,
        href: "ege-speaking-logic-comparison.html",
        score: p
      });
    }
    return prev;
